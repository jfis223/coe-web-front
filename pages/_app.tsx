      ...
      <Head>
        ...
        {process.env.NODE_ENV === "production" && (
          <meta
            ...
            content="default-src 'self' coe-web-cms.fly.dev; child-src 'none'; style-src 'self' unsafe-inline; script-src 'self' unsafe-inline; img-src res.cloudinary.com 'self'; object-src 'none'"
          />
        )}
